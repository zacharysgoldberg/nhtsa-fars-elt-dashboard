...
2. Cleaned CSV files are published to Azure Data Lake (Blob) Storage.
...
[Download the Power BI report (.pbix)](https://github.com/zacharysgoldberg/nhtsa-fars-elt-dashboard/releases/download/v1.0-dashboard/NHTSA.FARS.Analysis.pbix)
